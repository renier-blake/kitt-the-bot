...
const SKILLS: CapabilityInput[] = [
  ...
  // Memory & Diagnostics
  {
    ...
    execution: 'background',
    model: 'haiku',
    path: '.claude/skills/memory-search',
    triggers: ['herinnering', 'eerder', 'vorige', 'gesprek', 'memory'],
    modes: ['secure', 'developer'],
    sortOrder: 42,
  },
  ...
  // KITT Internal
  {
    ...
    description: 'View KITT logs and agent history',
    icon: '🔍',
    category: 'skill',
    skillType: 'system',
    execution: 'background',
    model: 'haiku',
    path: '.claude/skills/self-diagnostics',
    triggers: ['logs', 'errors', 'diagnostics', 'debug'],
    modes: ['developer'],
    sortOrder: 52,
  },
  {
    ...
    execution: 'background',
    model: 'opus',
    path: '.claude/skills/kitt-reflection',
    modes: ['developer'],
    sortOrder: 50,
  },
  {
    ...
    description: "Dagelijkse reflectie over de user(s)",
    icon: '👤',
    category: 'skill',
    skillType: 'system',
    execution: 'background',
    model: 'opus',
    path: '.claude/skills/user-reflection',
    modes: ['developer'],
    sortOrder: 53,
  },
  {
    id: 'business-reflection',
    name: 'Business Reflection',
    description: "Dagelijkse reflectie over het bedrijf",
    icon: '🏢',
    category: 'skill',
    skillType: 'system',
    execution: 'background',
    model: 'opus',
    path: '.claude/skills/business-reflection',
    modes: ['developer'],
    sortOrder: 54,
  },
  {
  ...
  {
    id: 'issue-kitt',
    name: 'Issue Workflow (Telegram)',
    description: 'Work on issues via Telegram',
    icon: '🎯',
    category: 'skill',
    skillType: 'system',
    execution: 'background',
    model: 'opus',
    path: '.claude/skills/issue-kitt',
    modes: ['developer'],
    sortOrder: 63,
  },
  {
    id: 'issue-claude',
    name: 'Issue Workflow (Claude Code)',
    description: 'Work on issues via Claude Code with Plan Mode',
    icon: '🎯',
    category: 'skill',
    skillType: 'system',
    execution: 'background',
    model: 'opus',
    path: '.claude/skills/issue-claude',
    modes: ['developer'],
    sortOrder: 64,
  },
];
